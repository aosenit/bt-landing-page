...
export default function Subscribe() {
  return (
    <section className="px-4 py-6 md:px-10 lg:px-16">
      <div className="w-full h-[600px] md:h-[530px] bg-cover bg-center bg-[#052B12] transition-all rounded-2xl duration-500 relative flex justify-center items-center">
        <div className="text-white flex flex-col items-center justify-center gap-4 p-4 md:p-8 rounded-lg">
          ...
          <h2 className="text-xl md:text-2xl lg:text-[40px] text-center w-full md:w-[60%]">
            Subscribe to our News letter
          </h2>
          <p className="text-base md:text-[20px] w-full md:w-[70%] text-center px-2">
            Get our latest news to stay update through our news. You can
            unsubscribe anytime
          </p>
          <div className="mt-8 flex flex-col md:flex-row gap-4 md:gap-[10rem] px-4 md:px-6 justify-between py-2 bg-white text-black rounded-4xl w-full max-w-[90%] md:max-w-none">
            <input
              type="email"
